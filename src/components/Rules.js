    ...
    <Grid container alignItems='center'>
      ...
      <Grid item>
        <Typography className={classes.text} variant='body1'>
          The initial pattern constitutes the seed of the system. Click on the
          cells to create your own seed, or click on the 'seed' button to create
          a random pattern. The first generation is created by applying the
          rules set forth above to every cell in the seed. Births and deaths
          occur simultaneously, and the discrete moment at which this happens is
          called a 'tick.' Each generation is a pure function of the preceding
          one. The rules are applied repeatedly to create future generations.
        </Typography>
      </Grid>
    </Grid>
  );
